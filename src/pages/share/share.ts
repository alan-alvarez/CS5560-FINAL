...
export class SharePage implements OnInit {
  ...
  constructor(private shareService: ShareProvider, 
  ...
  this.g = this.svg.append("g")
    ...
    console.log('parentHeight: ' + parentHeight);
		...
		if ((closevalue - buyvalue) >= 0) currentFill = "#00cc66"; 	//green for growth
		else currentFill = "#cc0000";								//red for decrease
		parentG.append("rect")
          .attr("class", "bar")
